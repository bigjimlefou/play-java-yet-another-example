...
public class JsonAction extends play.mvc.Action.Simple {
    public static final long TIMEOUT = 10L;
    private final Logger logger = LoggerFactory.getLogger("application.JsonAction");
    ...
    @Singleton
    @Inject
    public JsonAction(MetricRegistry metrics, HttpExecutionContext ec, Futures futures) {
        this.ec = ec;
        this.futures = futures;
        this.requestsMeter = metrics.meter("requestsMeter");
        this.responsesTimer = metrics.timer(name(JsonAction.class, "responsesTimer"));
    }
    ...
    public CompletionStage<Result> call(Http.Request request) {
        ...
        if (request.accepts("application/json")) {
            ...
            return futures.timeout(doCall(request), TIMEOUT, TimeUnit.SECONDS).exceptionally(e -> {
